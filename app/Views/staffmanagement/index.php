                            ...
                            <tbody>
                                <?php foreach ($datausers as $u) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url(); ?>/staffmanagement/updateUser/<?= $u['id']; ?>" class="badge badge-info" data-toggle="modal" data-target="#UbahDataUser<?= $u['id']; ?>"><i class="fa fas fa-edit"></i></a>
                                            <a href="<?= base_url(); ?>/staffmanagement/deleteUser/<?= $u['id']; ?>" class="badge badge-danger tombol-hapus"><i class="fa fas fa-trash"></i></a>
                                        </td>
                                    </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary tombol-add-staff">Save changes</button>
            </div>
        </div>
    </div>
</div>
...
<?php foreach ($datausers as $du) : ?>
    <div class="modal fade" id="UbahDataUser<?= $du['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="<?= base_url(); ?>/staffmanagement/updateUser/<?= $du['id']; ?>" method="post">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Modal title</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
